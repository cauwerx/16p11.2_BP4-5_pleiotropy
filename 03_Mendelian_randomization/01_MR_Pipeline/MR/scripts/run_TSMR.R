...
exposure_dat <- read_exposure_data(file.path(snakemake@input[["mr_data"]]),
                                   sep = " ",
                                   snp_col = "SNP", 
...
### Steiger filter ################################
# remove SNPs with larger outcome than exposure effects
...
ggsave(snakemake@output[[2]], mr_plots, width=3, height=3, units="in", scale=3)  