...
gwas_df = pd.read_csv(snakemake.params["path"], compression='gzip', sep = '\t', usecols = ["chr", "pos", "ref", "alt", "af_cases_EUR", "af_controls_EUR", "beta_EUR", "se_EUR", "neglog10_pval_EUR", "low_confidence_EUR"])
...
gwas_df["freq"] = (ncases*gwas_df["af_cases_EUR"] + ncontrols*gwas_df["af_controls_EUR"])/(ncases+ncontrols)
